...
namespace Payment
{
    public partial class list_of_scan_archive_deny : Form
    {
        ...
        public list_of_scan_archive_deny()
        {
            InitializeComponent();
        }
        ...
        private void list_of_scan_archive_deny_Load(object sender, EventArgs e)
        {
            SqlCommand command = new SqlCommand("select * from IMAGES where ZADANIE_PLAT_ID=" + archive_deny_ZNP.value_4_scan1, conn);
