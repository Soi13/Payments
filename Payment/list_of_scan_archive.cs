...
namespace Payment
{
    public partial class list_of_scan_archive : Form
    {
        ...
        private void list_of_scan_archive_Load(object sender, EventArgs e)
        {
            SqlCommand command = new SqlCommand("select * from IMAGES where ZADANIE_PLAT_ID=" + archive.value_4_scan1, conn);
